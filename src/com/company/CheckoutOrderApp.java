...
public class CheckoutOrderApp {
    ...
    public Double getTotalPrice() {
        ...
        for (String item : basketItems) {
            ...
            regularPriceQuantity = specialsObj.get("regularPriceQuantity");
            discountedQuantity = specialsObj.get("discountedQuantity");
            discountedPrice = specialsObj.get("discountedPrice");
    ...
    public HashMap<String, Double> applySpecials(String item, Double basketQuantity, Double regularPrice) {
        ...
        String specialType = special.type;
        Double discountedPrice = 0.0;
        Double discountedQuantity = 0.0;
